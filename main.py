...
"""
# Save scored object as a pickle file
with open('original_scored_loss_dist.pickle', 'wb') as f:
...
"""
# Save overall scored object as a pickle file
with open('original_scored.pickle', 'wb') as f:
    pickle.dump(scored, f)
"""
...
model.save("h5_files/Cloud_model_orig.h5")
print("Model saved")
