...
for filename in os.listdir(data_dir):
    ...
    dataset_part_a = dataset[:10240]
    dataset_part_b = dataset[10240:20480]
    dataset_mean_abs_part_a = np.array(dataset_part_a.abs().mean())
    dataset_mean_abs_part_b = np.array(dataset_part_b.abs().mean())
    dataset_mean_abs_part_a = pd.DataFrame(dataset_mean_abs_part_a.reshape(1, 4))
    dataset_mean_abs_part_b = pd.DataFrame(dataset_mean_abs_part_b.reshape(1, 4))
    dataset_mean_abs_part_a.index = [filename+".100000000"]
    dataset_mean_abs_part_b.index = [filename+".200000000"]
    merged_data = merged_data.append(dataset_mean_abs_part_a)
    merged_data = merged_data.append(dataset_mean_abs_part_b)
...
# train = merged_data['2004-02-12 10:52:39.100000000': '2004-02-15 12:52:39.100000000']
# test = merged_data['2004-02-15 12:52:39.200000000':]
train = merged_data.iloc[:1374,:]
test = merged_data.iloc[1375:,:]
